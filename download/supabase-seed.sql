...
('b0001-0001-0001-0001-0001-00000000005',
...
L''Inter ha conquistato matematicamente il quarto scudetto consecutivo battendo la Roma 3-0 allo Stadio Olimpico con cinque giornate di anticipo sulla fine del campionato. Il traguardo è stato raggiunto con un record assoluto di 32 vittorie, 4 pareggi e solo 2 sconfitte, per un totale di 100 punti. Lautaro Martinez, con 28 gol stagionali, si è aggiudicato la classifica cannonieri per il secondo anno consecutivo. Simone Inzaghi, tecnico nerazzurro, ha dichiarato che questo squadra rappresenta la più forte nella storia del club, superando persino la Grande Inter degli anni Sessanta di Helenio Herrera. Il presidente Steven Zhang ha annunciato estensioni contrattuali per tutto lo staff tecnico e il rafforzamento della rosa in vista della Champions League.',
 ...
 'Sport', 'a0001-0001-0001-0001-000000000005', 'Gazzetta dello Sport', 'https://gazzetta.it/inter-scudetto', 91, 4, 'published',
...
La Biennale d''Arte di Venezia ha assegnato il Leone d''Oro all''artista italiana Marta Ferretti per la sua installazione immersiva intitolata ''Echi Silenziosi'', un''opera che combina scultura tradizionale in marmo di Carrara con proiezioni generate in tempo reale da algoritmi di intelligenza artificiale. L''installazione occupa un''intera sala dell''Arsenale e invita i visitatori a interagire con superfici scultoree che rispondono al movimento e alla voce, creando un dialogo continuo tra la materia inerte e le forme digitali in evoluzione. La giuria internazionale ha definito l''opera come una meditazione profonda e originalissima sulla natura della creatività nell''era algoritmica.',
 ...
 'Cultura', 'a0001-0001-0001-0001-000000000006', 'Artribune', 'https://artribune.com/biennale-leone-oro', 93, 3, 'published',
...
I risultati della fase III della sperimentazione clinica del primo vaccino mRNA universale contro l''influenza hanno mostrato un''efficacia dell''89% contro tutte le varianti stagionali note del virus. Lo studio, condotto su 30.000 volontari in 15 paesi, ha dimostrato che il vaccino sviluppato da un consorzio di ricercatori europei offre una protezione duratura di almeno tre anni, eliminando la necessità di richiami annuali. Il meccanismo d''azione si basa sul targeting di 20 diverse proteine conservate del virus dell''influenza, rendendo estremamente difficile per il patogeno sviluppare resistenza. L''Agenzia Europea del Farmaco ha avviato la procedura di revisione accelerata, con una potenziale approvazione prevista entro la prossima stagione influenzale.',
 ...
 'Salute', 'a0001-0001-0001-0001-000000000007', 'ANSA Salute', 'https://ansa.it/salute/vaccino-mrna-influenza', 89, 3, 'published',
...
INSERT INTO approval_logs (id, article_id, reviewer_action, reviewer_note, reviewed_at) VALUES
  ...
  ('c0000001-0001-0001-0001-000000000004', 'b0001-0001-0001-0001-00000000005', 'approved', 'Notizia verificata e approvata dalla redazione', NOW() - INTERVAL '5 hours 30 minutes'),
  ('c0001-0001-0001-0001-000000000006', 'b0001-0001-0001-0001-000000000006', 'approved', 'Notizia verificata e approvata dalla redazione', NOW() - INTERVAL '2 days 10 hours'),
  ('c0001-0001-0001-0001-000000000007', 'b0001-0001-0001-0001-000000000007', 'approved', 'Notizia verificata e approvata dalla redazione', NOW() - INTERVAL '4 days 1 hour');
...
INSERT INTO publish_logs (id, article_id, platform, status, post_id, post_url, error, published_at) VALUES
  ...
  ('p0000001-0001-0001-0001-000000000016', 'b0001-0001-0001-0001-00000000005', 'blog', 'published', 'post_gazzetta_05', 'https://blog.com/nexusnews/b0005', '', NOW() - INTERVAL '1 day 2 hours'),
  ('p0000001-0001-0001-0001-000000000017', 'b0001-0001-0001-0001-00000000005', 'twitter', 'published', 'post_x_gazzetta_05', 'https://x.com/nexusnews/status/b0005', '', NOW() - INTERVAL '1 day 2 hours'),
  ('p0000001-0001-0001-0001-000000000018', 'b0001-0001-0001-0001-00000000005', 'facebook', 'published', 'post_fb_gazzetta_05', 'https://fb.com/nexusnews/posts/b0005', '', NOW() - INTERVAL '1 day 2 hours'),
  ('p0000001-0001-0001-0001-000000000019', 'b0001-0001-0001-0001-00000000005', 'linkedin', 'failed', '', '', 'Timeout di connessione', NULL),
  ('p0000001-0001-0001-0001-000000000020', 'b0001-0001-0001-0001-00000000005', 'instagram', 'published', 'post_ig_gazzetta_05', 'https://instagram.com/nexusnews/b0005', '', NOW() - INTERVAL '1 day 2 hours'),
  ('p0000001-0001-0001-0001-000000000021', 'b0001-0001-0001-0001-00000000006', 'blog', 'published', 'post_artribune_06', 'https://blog.com/nexusnews/b0006', '', NOW() - INTERVAL '2 days 10 hours'),
  ('p0000001-0001-0001-0001-000000000022', 'b0001-0001-0001-0001-00000000006', 'twitter', 'published', 'post_x_artribune_06', 'https://x.com/nexusnews/status/b0006', '', NOW() - INTERVAL '2 days 10 hours'),
  ('p0000001-0001-0001-0001-000000000023', 'b0001-0001-0001-0001-00000000006', 'facebook', 'published', 'post_fb_artribune_06', 'https://fb.com/nexusnews/posts/b0006', '', NOW() - INTERVAL '2 days 10 hours'),
  ('p0000001-0001-0001-0001-000000000024', 'b0001-0001-0001-0001-00000000006', 'linkedin', 'published', 'post_li_artribune_06', 'https://linkedin.com/posts/nexusnews/b0006', '', NOW() - INTERVAL '2 days 10 hours'),
  ('p0000001-0001-0001-0001-000000000025', 'b0001-0001-0001-0001-00000000006', 'instagram', 'published', 'post_ig_artribune_06', 'https://instagram.com/nexusnews/b0006', '', NOW() - INTERVAL '2 days 10 hours'),
  ('p0000001-0001-0001-0001-000000000026', 'b0001-0001-0001-0001-00000000007', 'blog', 'published', 'post_ansa_07', 'https://blog.com/nexusnews/b0007', '', NOW() - INTERVAL '4 days 1 hour'),
  ('p0000001-0001-0001-0001-000000000027', 'b0001-0001-0001-0001-00000000007', 'twitter', 'published', 'post_x_ansa_07', 'https://x.com/nexusnews/status/b0007', '', NOW() - INTERVAL '4 days 1 hour'),
  ('p0000001-0001-0001-0001-000000000028', 'b0001-0001-0001-0001-00000000007', 'facebook', 'published', 'post_fb_ansa_07', 'https://fb.com/nexusnews/posts/b0007', '', NOW() - INTERVAL '4 days 1 hour'),
  ('p0000001-0001-0001-0001-000000000029', 'b0001-0001-0001-0001-00000000007', 'linkedin', 'published', 'post_li_ansa_07', 'https://linkedin.com/posts/nexusnews/b0007', '', NOW() - INTERVAL '4 days 1 hour'),
  ('p0000001-0001-0001-0001-000000000030', 'b0001-0001-0001-0001-00000000007', 'instagram', 'published', 'post_ig_ansa_07', 'https://instagram.com/nexusnews/b0007', '', NOW() - INTERVAL '4 days 1 hour');
...
L''Unione Europea ha ufficialmente attivato la fase operativa completa dell''AI Act, il primo quadro normativo al mondo sull''intelligenza artificiale. Le aziende tecnologiche operanti nel mercato europeo hanno ora 90 giorni per dimostrare la piena conformità con le disposizioni sulla trasparenza algoritmica, la documentazione tecnica e la gestione dei rischi. Il regolamento classifica i sistemi AI in quattro categorie di rischio, da inaccettabile a minimo, con requisiti proporzionalmente differenziati. Thierry Breton, Commissario europeo per il Mercato Interno, ha dichiarato che l''UE intende essere il riferimento globale per la governance dell''IA, e ha annunciato la creazione di un corpo di ispezione dedicato con oltre 200 esperti tecnici. Le sanzioni per le violazioni possono arrivare fino al 7% del fatturato globale annuo.',
  ...
  'Reuters Europa', 'https://reuters.com/eu/2026/07/ai-act-operative', 86, 3, 'pending_approval');
...
INSERT INTO activity_logs (id, agent_id, action, detail, status, created_at) VALUES
  ...
  ('l0000003', 'a0000001-0001-0001-0001-000000000001', 'publishing', 'Pubblicato: 